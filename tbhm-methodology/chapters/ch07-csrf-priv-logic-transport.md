...
> **Ownership + taxonomy note:** all cross-account checks use your own two accounts; "IDOR" now splits to BOLA/BOPLA in the 2023 API taxonomy (`owasp-api-security-top-10`). Business-logic abuse = API6:2023 — see `web-app-hackers-handbook/chapters/ch10-application-logic.md` (WAHH source Chapter 11) for durable technique.
